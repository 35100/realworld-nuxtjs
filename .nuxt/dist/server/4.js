...
// CONCATENATED MODULE: ./node_modules/_vue-loader@15.9.8@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_vue-loader@15.9.8@vue-loader/lib??vue-loader-options!./pages/profile/index.vue?vue&type=template&id=4b6ef1b4&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"profile-page"},[_vm._ssrNode("<div class=\"user-info\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<div class=\"container\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<div class=\"row\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<div class=\"col-xs-12 col-md-10 offset-md-1\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<img"+(_vm._ssrAttr("src",_vm.profile.image?_vm.profile.image:'/smiley-cyrus.jpg'))+" class=\"user-img\" data-v-4b6ef1b4> <h4 data-v-4b6ef1b4>"+_vm._ssrEscape(_vm._s(_vm.profile.username))+"</h4> <p data-v-4b6ef1b4>"+_vm._ssrEscape(_vm._s(_vm.profile.bio))+"</p> "),(_vm.user.username===_vm.profile.username)?[_c('nuxt-link',{staticClass:"btn btn-sm btn-outline-secondary action-btn",attrs:{"to":"/settings"}},[_c('i',{staticClass:"ion-gear-a"}),_vm._v(" Edit Profile Settings\n            ")])]:_vm._ssrNode("<button"+(_vm._ssrAttr("disabled",_vm.profile.followDisabled))+" class=\"btn btn-sm btn-outline-secondary action-btn\" data-v-4b6ef1b4><i class=\"ion-plus-round\" data-v-4b6ef1b4></i>"+_vm._ssrEscape("\n               \n              "+_vm._s(_vm.profile.following?"Unfollow ":"Follow ")+_vm._s(_vm.profile.username)+"\n            ")+"</button>")],2)])])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<div class=\"row\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<div class=\"col-xs-12 col-md-10 offset-md-1\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<div class=\"articles-toggle\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<ul class=\"nav nav-pills outline-active\" data-v-4b6ef1b4>","</ul>",[_vm._ssrNode("<li class=\"nav-item\" data-v-4b6ef1b4>","</li>",[_c('nuxt-link',{staticClass:"nav-link",class:{active:_vm.tab==='My'},attrs:{"to":{name:'profile',params:{username: _vm.username}},"exact":""}},[_vm._v("My Articles")])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"nav-item\" data-v-4b6ef1b4>","</li>",[_c('nuxt-link',{staticClass:"nav-link",class:{active:_vm.tab==='Favorited'},attrs:{"exact":"","to":{name:'profile',query:{tab:'Favorited'},params:{username: _vm.username}}}},[_vm._v("Favorited Articles")])],1)],2)]),_vm._ssrNode(" "),_vm._l((_vm.articles),function(article){return _vm._ssrNode("<div class=\"article-preview\" data-v-4b6ef1b4>","</div>",[_vm._ssrNode("<div class=\"article-meta\" data-v-4b6ef1b4>","</div>",[_c('nuxt-link',{attrs:{"to":{name:'article',params:{slug:article.slug}}}},[_c('img',{attrs:{"src":article.author.image?article.author.image:'http://i.imgur.com/N4VcUeJ.jpg'}})]),_vm._ssrNode(" <div class=\"info\" data-v-4b6ef1b4><a href=\"#\" class=\"author\" data-v-4b6ef1b4>"+_vm._ssrEscape(_vm._s(article.author.username))+"</a> <span class=\"date\" data-v-4b6ef1b4>"+_vm._ssrEscape(_vm._s(_vm._f("date")(article.createdAt)))+"</span></div> <button"+(_vm._ssrAttr("disabled",article.favoriteDisabled))+(_vm._ssrClass("btn btn-sm pull-xs-right",article.favorited?'btn-primary':'btn-outline-primary'))+" data-v-4b6ef1b4><i class=\"ion-heart\" data-v-4b6ef1b4></i>"+_vm._ssrEscape("\n              "+_vm._s(article.favoritesCount)+"\n            ")+"</button>")],2),_vm._ssrNode(" "),_c('nuxt-link',{staticClass:"preview-link",attrs:{"to":{name:'article',params:{slug:article.slug}}}},[_c('h1',[_vm._v(_vm._s(article.title))]),_vm._v(" "),_c('p',[_vm._v(_vm._s(article.description))]),_vm._v(" "),_c('span',[_vm._v("Read more...")]),_vm._v(" "),_c('ul',{staticClass:"tag-list"},_vm._l((article.tagList),function(tag,i){return _c('li',{key:i,staticClass:"tag-default tag-pill tag-outline"},[_vm._v(_vm._s(tag))])}),0)])],2)}),_vm._ssrNode(" "),_vm._ssrNode("<nav data-v-4b6ef1b4>","</nav>",[_vm._ssrNode("<ul class=\"pagination\" data-v-4b6ef1b4>","</ul>",_vm._l((_vm.totalPage),function(item){return _vm._ssrNode("<li"+(_vm._ssrClass(null,['page-item', {active:item===_vm.page}]))+" data-v-4b6ef1b4>","</li>",[_c('nuxt-link',{staticClass:"page-link",attrs:{"to":{name:'profile',query:{page:item,tab: _vm.tab},params:{username: _vm.username}}}},[_vm._v(_vm._s(item))])],1)}),0)])],2)])])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/profile/index.vue?vue&type=template&id=4b6ef1b4&scoped=true&
