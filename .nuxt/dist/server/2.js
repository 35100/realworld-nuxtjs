...
// CONCATENATED MODULE: ./node_modules/_vue-loader@15.9.8@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_vue-loader@15.9.8@vue-loader/lib??vue-loader-options!./pages/editor/index.vue?vue&type=template&id=e8912500&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"editor-page"},[_vm._ssrNode("<div class=\"container page\" data-v-e8912500><div class=\"row\" data-v-e8912500><div class=\"col-md-10 offset-md-1 col-xs-12\" data-v-e8912500><form data-v-e8912500><fieldset data-v-e8912500><fieldset class=\"form-group\" data-v-e8912500><input type=\"text\" required=\"required\" placeholder=\"Article Title\""+(_vm._ssrAttr("value",(_vm.article.title)))+" class=\"form-control form-control-lg\" data-v-e8912500></fieldset> <fieldset class=\"form-group\" data-v-e8912500><input type=\"text\" required=\"required\" placeholder=\"What's this article about?\""+(_vm._ssrAttr("value",(_vm.article.description)))+" class=\"form-control\" data-v-e8912500></fieldset> <fieldset class=\"form-group\" data-v-e8912500><textarea rows=\"8\" placeholder=\"Write your article (in markdown)\" required=\"required\" class=\"form-control\" data-v-e8912500>"+(_vm._s(_vm.article.body))+"</textarea></fieldset> <fieldset class=\"form-group\" data-v-e8912500><input type=\"text\" placeholder=\"Enter tags\""+(_vm._ssrAttr("value",(_vm.newTag)))+" class=\"form-control\" data-v-e8912500> <div class=\"tag-list\" data-v-e8912500>"+(_vm._ssrList((_vm.article.tagList),function(tag,i){return ("<span class=\"tag-default tag-pill\" data-v-e8912500><i class=\"ion-close-round\" data-v-e8912500></i>"+_vm._ssrEscape("\n                  "+_vm._s(tag)+"\n              ")+"</span>")}))+"</div></fieldset> <button"+(_vm._ssrAttr("disabled",_vm.publishDisabled))+" type=\"button\" class=\"btn btn-lg pull-xs-right btn-primary\" data-v-e8912500>Publish Article</button></fieldset></form></div></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/editor/index.vue?vue&type=template&id=e8912500&scoped=true&
  ...
  methods: {
    ...
    async submitArticle() {
      try {
        ...
        const {
          data
        } = this.slug ? await Object(article["m" /* updateArticle */])(this.slug, {
